...
### POCs
A pair of test programs utilziing a common POCEngine.py file which to extract tweets (via the Twitter API) based on a given input and analyze sentiment via the Google NLP API.
